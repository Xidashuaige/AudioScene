...
namespace SUPERCharacter
{
    ...
    //All
        ...
        List<AudioSource> currentClipSet = new List<AudioSource>();
        [Space(18)]
        #endregion
    ...
    public Key interactKey = Key.E;
        ...
        void Start()
        {
            ...
            foreach (var set in footstepSoundSet)
            {
                set.footstepClips = set.footstepClips[0].gameObject
                .GetComponents<AudioSource>().ToList<AudioSource>();
                set._matInstanceName = set._Materials.Select(mat => mat.name + " (Instance)").ToArray<string>();
            }
            #endregion
        ...
        {
            if (enableFootstepSounds && footstepSoundSet.Any() && currentGroundInfo.groundMaterial)
            {
                ...
                if (currentClipSet != null && currentClipSet.Any())
                {
                    ...
                    currentClipSet[Random.Range(0, currentClipSet.Count())].Play();
                }
            }
        }
        #endregion
    ...
    public class GroundMaterialProfile
    {
        ...
        public string[] _matInstanceName;
        public List<PhysicMaterial> _physicMaterials;
        public List<TerrainLayer> _Layers;
        public List<AudioSource> footstepClips = new List<AudioSource>();
    ...
    public class SuperFPEditor : Editor
    {
        ...
        if(GUI.changed){EditorUtility.SetDirty(t); Undo.RecordObject(t,"Undo Vault Setting changes"); tSO.ApplyModifiedProperties();}
            ...
            if (footStepFoldout)
            {
                ...
                if (GUILayout.Button(new GUIContent("Add Profile", "Add new profile"))) { t.footstepSoundSet.Add(new GroundMaterialProfile() { profileTriggerType = MatProfileType.Material, _Materials = null, _Layers = null, footstepClips = new List<AudioSource>() }); UpdateGroundProfiles(); }
